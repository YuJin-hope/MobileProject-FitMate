...
import { View, StyleSheet, ToastAndroid, TouchableHighlight, Button, Text, ScrollView } from 'react-native';
  ...
  const renderRecords = () => {
    ...
    return (
      <ScrollView>
        ...
        <Text style={{ color: 'white', fontSize: 18, fontWeight: 'bold', marginBottom: 10 }}>{selectedDate}:</Text>
          ...
          <View style={{ marginBottom: 10 }}>
            ...
            <Text style={{ color: 'white'}}>총 칼로리: {breakfastKcalSum} kcal</Text>
            <Text style={{ color: 'white'}}>총 단백질: {breakfastProteinSum} g</Text>
          </View>
          )}
          ...
          <View style={{ marginBottom: 10 }}>
            ...
            <Text style={{ color: 'white'}}>총 칼로리: {lunchKcalSum} kcal</Text>
            <Text style={{ color: 'white'}}>총 단백질: {lunchProteinSum} g</Text>
          </View>
          )}
          ...
          <View style={{ marginBottom: 10 }}>
            ...
            <Text style={{ color: 'white'}}>총 칼로리: {dinnerKcalSum} kcal</Text>
            <Text style={{ color: 'white'}}>총 단백질: {dinnerProteinSum} g</Text>
          </View>
          )}
        </View>
      </ScrollView>
